    ...
    <div class="reset-password-container">
        <div class="container">
            <div class="reset-password-card">
                ...
                <form action="process_reset_password.php" method="POST" onsubmit="return validatePassword()">
                    ...
                    <button type="submit" class="btn btn-reset">Set New Password</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function checkPasswordStrength() {
            ...
            switch (strength) {
                case 0:
                case 1:
                    strengthDiv.innerHTML = '<span class="text-danger">Very Weak</span>';
                    break;
                case 2:
                    strengthDiv.innerHTML = '<span class="text-warning">Weak</span>';
                    break;
                case 3:
                    strengthDiv.innerHTML = '<span class="text-info">Medium</span>';
                    break;
                case 4:
                    strengthDiv.innerHTML = '<span class="text-primary">Strong</span>';
                    break;
                case 5:
                    strengthDiv.innerHTML = '<span class="text-success">Very Strong</span>';
                    break;
            }
        }
