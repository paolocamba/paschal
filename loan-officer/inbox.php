...
<head>
    ...
    <title>Inbox | Loan Officer</title>
    <!-- plugins:css -->
                                            ...
                                            <?php if ($result->num_rows > 0): ?>
                                                <?php while ($row = $result->fetch_assoc()): ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo date('F d, Y h:i A', strtotime($row['datesent'])); ?>
                                                        </td>
                                                    ...
                                                    <div class="modal fade" id="viewModal<?php echo $row['message_id']; ?>"
                                                        tabindex="-1" role="dialog"
                                                        aria-labelledby="viewModalLabel<?php echo $row['message_id']; ?>"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="viewModalLabel<?php echo $row['message_id']; ?>">
                                                                        Message Details</h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="message-details">
                                                                        ...
                                                                        <p><strong>Date Sent:</strong>
                                                                            <?php echo date('F d, Y h:i A', strtotime($row['datesent'])); ?>
                                                                        </p>

                                                                        <!-- Admin Reply Section -->
                                                                        <?php if (!empty($row['loan_reply'])): ?>
                                                                            <hr>
                                                                            <div class="loan-reply">
                                                                                <h6>Medical Officer Reply:</h6>
                                                                                <p><strong>Reply:</strong>
                                                                                    <?php echo htmlspecialchars($row['loan_reply']); ?>
                                                                                </p>
                                                                                <p><strong>Reply Date:</strong>
                                                                                    <?php echo htmlspecialchars($row['loan_reply_date']); ?>
                                                                                </p>
                                                                            </div>
                                                                        <?php endif; ?>
                                                                    </div>
                                                    ...
                                                    <!-- Reply Modal -->
                                                    <div class="modal fade" id="replyModal<?php echo $row['message_id']; ?>"
                                                        tabindex="-1" role="dialog"
                                                        aria-labelledby="replyModalLabel<?php echo $row['message_id']; ?>"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="replyModalLabel<?php echo $row['message_id']; ?>">
                                                                        Reply to Message</h5>
                                                                    <button type="button" class="close" data-dismiss="modal"
                                                                        aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                ...
                                                                <form action="reply.php" method="POST">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="replyText<?php echo $row['message_id']; ?>">Your
                                                                                Reply</label>
                                                                            <textarea class="form-control"
                                                                                id="replyText<?php echo $row['message_id']; ?>"
                                                                                name="loan_reply" rows="4" required></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                            ...
                            <form action="send_message.php" method="POST">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="loan_message" name="loan_message" rows="4"
                                            required></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
