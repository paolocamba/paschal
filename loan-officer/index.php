        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="row">
                    ...
                    <?php
                        // Query to count active loans and loan applications
                        $status_sql = "SELECT 
                            (SELECT COUNT(*) FROM `credit_history` WHERE `ApprovalStatus` = 'Approved') as active_loans_count,
                            (SELECT COUNT(*) FROM `loanapplication`) as total_loan_applications_count";
