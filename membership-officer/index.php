        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="row">
                    ...
                    // Status count query
                    $status_sql = "SELECT 
                        (SELECT COUNT(*) FROM `users` WHERE membership_status='Pending' AND user_type='Member') as pending_membership_count,
                        (SELECT COUNT(*) FROM `users` WHERE membership_status='Active' AND user_type='Member') as active_membership_count";
                    ...
                    <div class="col-md-6 grid-margin transparent">
                        <div class="row">
                            <div class="col-md-6 mb-4 stretch-card transparent">
                                <div class="card card" style="background: #FFA500;">
                                    <div class="card-body">
                                        <p class="mb-4 text-white">Total Number of Pending Membership Applications</p>
                                        <p class="fs-30 mb-2 text-white"><?php echo $row['pending_membership_count']; ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4 stretch-card transparent">
                                <div class="card card" style="background: #008080;">
                                    <div class="card-body">
                                        <p class="mb-4 text-white">Total Number of Active Membership Applications</p>
                                        <p class="fs-30 mb-2 text-white"><?php echo $row['active_membership_count']; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
