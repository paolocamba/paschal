    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                ?>
                <!-- Services Modal -->
                <div class="modal fade" id="postServiceModal" tabindex="-1" aria-labelledby="postServiceModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="postServiceModalLabel">New Service</h5>
                                ...
                                <form action="add_service.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="serviceType" name="type" required>
                                            ...
                                            <option value="Members Savings">Members Savings</option>
                                            <option value="Members Share Capital">Members Share Capital</option>
                                        </select>
                                    </div>
        ...
        .navbar {
            ...
            margin-top: 0 !important;
                ...
                try {
                    // Query to fetch services data by searching all columns
                    $sql = "SELECT id, name, type, created_at 
                        FROM services 
                        WHERE id LIKE ? 
                           OR name LIKE ? 
                           OR type LIKE ? 
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                                    <p class="card-title mb-0">Services</p>
                                    <div class="ml-auto">
                                        <button class="btn btn-primary mb-3" data-toggle="modal"
                                            data-target="#postServiceModal">Add Service</button>
                                    </div>
                                </div>
                                <div class="mb-3">
                                        ...
                                        <tbody>
                                            <?php if ($result->num_rows > 0): ?>
                                                <?php while ($row = $result->fetch_assoc()): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-primary btn-sm" data-toggle="modal"
                                                                data-target="#editServiceModal<?php echo $row['id']; ?>">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </button>
                                                            <button class="btn btn-danger btn-sm" data-toggle="modal"
                                                                data-target="#deleteServiceModal<?php echo $row['id']; ?>">
                                                    ...
                                                    <!-- Edit Service Modal -->
                                                    <div class="modal fade" id="editServiceModal<?php echo $row['id']; ?>"
                                                        tabindex="-1" aria-labelledby="editServiceModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <form action="edit_service.php" method="POST">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <select class="form-control" id="type" name="type"
                                                                                ...
                                                                                <option value="Medical" <?php echo ($row['type'] == 'Medical') ? 'selected' : ''; ?>>Medical</option>
                                                                                <option value="Loan" <?php echo ($row['type'] == 'Loan') ? 'selected' : ''; ?>>Loan</option>
                                                                                <option value="Membership Payment" <?php echo ($row['type'] == 'Membership Payment') ? 'selected' : ''; ?>>Membership Payment</option>
                                                                                <option value="Members Savings" <?php echo ($row['type'] == 'Members Savings') ? 'selected' : ''; ?>>Members Savings</option>
                                                                                <option value="Members Share Capital" <?php echo ($row['type'] == 'Members Savings') ? 'selected' : ''; ?>>Members Share Capital</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary"
                                                    ...
                                                    <div class="modal fade" id="deleteServiceModal<?php echo $row['id']; ?>"
                                                        tabindex="-1" role="dialog" aria-labelledby="deleteServiceModalLabel"
                                                        aria-hidden="true">
