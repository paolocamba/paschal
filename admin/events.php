      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <!-- Events Modal -->
            <div class="modal fade" id="postEventsModal" tabindex="-1" aria-labelledby="postEventsModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="postEventsModalLabel">New Event</h5>
                        ...
                        <div class="modal-body">
                            <form action="add_event.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="eventDescription" name="description" placeholder="Enter event description" rows="3" required></textarea>
                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="saveEventBtn">Save Events</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            $sql = "SELECT 
                    ...
                    OR description LIKE ? 
                    OR event_date LIKE ? 
                    OR DATE_FORMAT(event_date, '%M %d, %Y') LIKE ?
                    LIMIT ? OFFSET ?";
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                                ...
                                <div class="ml-auto">
                                    <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#postEventsModal" style="background-color: #03C03C;">Add Event</button>
                                </div>
                            </div>
                            <div class="mb-3">
                                <form method="GET" action="" class="form-inline" id="searchForm">
                                    <div class="input-group mb-2 mr-sm-2">
                                        <input type="text" name="search" id="searchInput" class="form-control" value="<?php echo htmlspecialchars($search); ?>" placeholder="Search Events">
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php if (!empty($row['image'])): ?>
                                                            <img src="../dist/assets/images/events/<?php echo htmlspecialchars($row['image']); ?>" alt="Event Image" style="max-width: 100px; max-height: 100px;">
                                                        <?php else: ?>
                                                            No Image
                                                        <?php endif; ?>
                                                    </td>
                                                                ...
                                                                <form action="edit_event.php" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="custom-file-input-wrapper">
                                                                            ...
                                                                            <?php if (!empty($row['image'])): ?>
                                                                                <img src="../dist/assets/images/events/<?php echo htmlspecialchars($row['image']); ?>" id="currentImagePreview" alt="Current Image" class="current-image">
                                                                            <?php endif; ?>
                                                                        </div>
                                                                    </div>
                                                                    <div class="mb-3">
