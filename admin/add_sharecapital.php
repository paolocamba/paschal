...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // 1. Insert into share_capital table
        $query = "INSERT INTO share_capital (MemberID, Amount, PaymentMethod, Notes, Status) 
                 VALUES (?, ?, ?, ?, ?)";
        ...
        if (!$savings_result) {
            throw new Exception("Error inserting into share_capital table");
        }
        ...
        $description = 'Share Capital Deposit';  // Added description
        ...
        $service_name = 'Share Capital Deposit';
        ...
        header("Location: sharecapital.php?success=1");
        exit();
        ...
        header("Location: sharecapital.php?error=1");
        exit();
    }
}
