...
<body>
  ...
  <div class="container-fluid page-body-wrapper">
    ...
    // Get total approved savings and calculate interest - matching MemberID with session user_id
    ...
    // Calculate savings percentage this month - matching MemberID
    ...
    // Get total approved share capital and calculate interest - matching MemberID
    ...
    // Calculate share capital percentage this month - matching MemberID
    ...
    // Get active services - matching user_id in transactions
    ...
    // Get loan eligibility and approval status - matching MemberID
    $loan_query = "SELECT LoanEligibility, ApprovalStatus 
    FROM credit_history 
    WHERE MemberID = ? 
    ...
    $loan_eligibility = $loan_data['LoanEligibility'] ?? 'N/A';
    $approval_status = $loan_data['ApprovalStatus'] ?? 'N/A';

    // Get last transaction - matching user_id
    ...
    <?php
     ...
     $shareCapitalResult = $shareCapitalStmt->get_result();
        ...
        <div class="container mt-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($loans['Status'] == 'In Progress'): ?>
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#cancelLoanModal" data-loan-id="<?php echo $loan['LoanID']; ?>">
                                                        Cancel Loan
                                                    </button>
                                                <?php else: ?>
            ...
            <!-- JavaScript to Set Loan ID -->
            <script>
                var cancelLoanButtons = document.querySelectorAll('[data-bs-toggle="modal"]');
                cancelLoanButtons.forEach(function(button) {
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php while($loan = $loan_result->fetch_assoc()): 
                                        // Calculate total payment (loanable_amount + interest)
                                        $total_payment = $loan['loanable_amount'] + ($loan['loanable_amount'] * ($loan['InterestRate'] / 100));
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>₱<?php echo number_format($loan['loanable_amount'], 2); ?></td>
            ...
            <!-- Payment Modals (Outside the card) -->
            <?php 
