...
<head>
    ...
    <title>Regular Loan Form 6 | Member</title>
    <!-- plugins:css -->
            ...
            <div class="content-wrapper">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    try {
                        ...
                        if ($stmt->execute()) {
                            ...
                            header("Location: regular-form7.php?loanType=" . urlencode($loan_type));
                            exit();
                        } else {
                ...
                <div class="container">
                    ...
                    <h1 class="heading"><?php echo ucfirst($loan_type); ?> Loan Application - Document Submission</h1>
                        <form action="regular-form6.php" method="post" enctype="multipart/form-data" id="documentForm">
                            <div class="row mb-4">
