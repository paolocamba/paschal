...
<head>
    ...
    <title>Collateral Success | Member</title>
    <!-- plugins:css -->
            ...
            <div class="content-wrapper">
                ...
                <div class="container">
                    <div class="success-container">
                        <h2 class="success-heading">Application Successfully Submitted!</h2>
                        <p class="success-message">Wait for your email confirmation. Thank you!</p>
