...
<body>
    ...
    <div class="container membership-container">
        <h2 class="text-center mb-4">Membership Types</h2>
        ...
        <div class="membership-type">
            <h3>2. Regular Membership</h3>
            <p>5 thousand Pesos Share Capital and at least 1000.00 Pesos Savings deposit</p>
            
            <div class="membership-breakdown">
                <h5>Breakdown for Regular Membership:</h5>
                <ul>
                    <li><strong>5,000.00 PHP</strong> – Share Capital</li>
                    <li><strong>1,000.00 PHP</strong> – (At least) Savings Deposit</li>
                    <li><strong>450.00 PHP</strong> – Insurance for 18 years old up to 64 years old</li>
                    <li><strong>550.00 PHP</strong> – Insurance for 65 years old to 75 years old</li>
                    <li><strong>300.00 PHP</strong> – Membership Fee</li>
                ...
                <p class="mt-3">
                    <strong>Total:</strong><br>
                    <strong>6,750 Pesos</strong> – 18 to 64 Years Old<br>
                    <strong>6,850 Pesos</strong> – 65 to 75 Years Old
                </p>
            </div>
        </div>

        <button class="btn btn-continue" onclick="continueToNextStep()">
            Continue
        </button>
    </div>
