...
<head>
  ...
  <title>Inbox | Medical Officer</title>
<!-- plugins:css -->
                                                                ...
                                                                <div class="message-details">
                                                                    ...
                                                                    <?php if(!empty($row['admin_reply'])): ?>
                                                                        ...
                                                                        <div class="admin-reply">
                                                                            ...
                                                                            <p><strong>Reply:</strong> <?php echo htmlspecialchars($row['medical_reply']); ?></p>
                                                                            <p><strong>Reply Date:</strong> <?php echo htmlspecialchars($row['medical_reply_date']); ?></p>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <form action="reply.php" method="POST">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea class="form-control" id="replyText<?php echo $row['message_id']; ?>" name="medical_reply" rows="4" required></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                        ...
                        <form action="send_message.php" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="medical_message" name="medical_message" rows="4" required></textarea>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
