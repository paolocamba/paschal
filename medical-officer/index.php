...
<head>
  ...
  <title>Dashboard | Medical Officer</title>
  <!-- plugins:css -->
    ...
    <div class="main-panel">
      <div class="content-wrapper">
        ...
        <div class="row">
          ...
          // Status count query 
          $status_sql = "SELECT 
          (SELECT COUNT(*) FROM `transactions` WHERE payment_status='Completed' AND service_name IN ('Medical Consultation', 'Laboratory', 'X-RAY', 'Hilot Healom', 'Healom Health Card')) as completed_count,
          (SELECT COUNT(*) FROM `transactions` WHERE payment_status='In Progress' AND service_name IN ('Medical Consultation', 'Laboratory', 'X-RAY', 'Hilot Healom', 'Healom Health Card')) as in_progress_count";
          ...
          <div class="col-md-6 grid-margin transparent">
            <div class="row">
              <div class="col-md-6 mb-4 stretch-card transparent">
                <div class="card card" style="background: #03C03C;">
                  <div class="card-body">
                    <p class="mb-4 text-white">Total Number of Completed Medical Services</p>
                    <p class="fs-30 mb-2 text-white"><?php echo $row['completed_count']; ?></p>
                  </div>
                </div>
              </div>
              <div class="col-md-6 mb-4 stretch-card transparent">
                <div class="card card" style="background: #03C03C;">
                  <div class="card-body">
                    <p class="mb-4 text-white">Total Number Of In Progress Medical Services </p>
                    <p class="fs-30 mb-2 text-white"><?php echo $row['in_progress_count']; ?></p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <!--<div class="col-md-6 stretch-card transparent">
                            <div class="card card-light-danger">
                                <div class="card-body">
                                    <p class="mb-4">Total Number Of Lab Assistant</p>
